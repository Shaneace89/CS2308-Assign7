/*File Name: CharStack.cpp
 ...
 Match Brackets using a Stack, Holds definitions for funcitons in CharStack.h */
...
{
    assert(!isEmpty());
    int last = stackString.size() - 1;  //hold postion of last char
...
/******************************************************************
 ...
 returns: boolian value, true if full, else false
 ******************************************************************/
...
/******************************************************************
 isEmpty: checkis if string is empty
 returns: boolian value, true if empty, else false
 ******************************************************************/
